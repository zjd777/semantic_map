...
class Controller(Node):
    ...
    def cmd_vel_callback(self, msg):
        if self.machine_type != 'ROSOrin_Acker':
            ...
            elif 'Differential' in self.machine_type:
                self.linear_x = msg.linear.x
                self.linear_y = 0.0
                self.angular_z = msg.angular.z
