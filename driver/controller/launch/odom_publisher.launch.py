...
def generate_launch_description():
    ...
    if compiled == 'True':
        robot_description_package_path = get_package_share_directory('rosorin_description')
        robot_controller_package_path = get_package_share_directory('ros_robot_controller')
        controller_package_path = get_package_share_directory('controller')
    else:
        robot_description_package_path = '/home/ubuntu/ros2_ws/src/simulations/rosorin_description'
        robot_controller_package_path = '/home/ubuntu/ros2_ws/src/driver/ros_robot_controller'
        controller_package_path = '/home/ubuntu/ros2_ws/src/driver/controller'

    robot_description_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([os.path.join(robot_description_package_path, 'launch/robot_description.launch.py')
        ]),
        launch_arguments={
