...
def launch_setup(context):
    ...
    depth_camera_topic = '/depth_cam/depth0/image_raw'.format(topic_prefix)
    depth_camera_info = '/depth_cam/rgb0/camera_info'.format(topic_prefix)
    rgb_camera_topic = '/depth_cam/rgb0/image_raw'.format(topic_prefix)
