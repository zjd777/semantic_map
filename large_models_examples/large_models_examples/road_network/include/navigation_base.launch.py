...
def launch_setup(context):
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(large_models_example_package_path, 'road_network/config/nav2_params.yaml'),
    ...
    controller_param = os.path.join(large_models_example_package_path, 'road_network/config/nav2_controller_rpp.yaml')
