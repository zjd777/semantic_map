...
def generate_launch_description():
	...
	amcl_node = Node(
        ...
        package='nav2_amcl',
        executable='amcl',
        parameters=[os.path.join(get_package_share_directory('multi'),'param','robot1_amcl_param.yaml')],
        remappings=[
					('/initialpose', '/robot_1/initialpose'),
					('amcl_pose', '/robot_1/amcl_pose'),
					('particle_cloud', '/robot_1/particle_cloud')
					# ('/map', '/map'),
					# ('/scan', '/robot_1/scan')
